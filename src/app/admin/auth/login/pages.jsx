...
import { loginSchema } from "@/lib/validationSchemas"; // Pastikan schema sudah benar
...
export default function AdminLoginPage() {
  ...
  const handleLoginSuccess = (user) => {
    ...
    // Redirect user to the admin dashboard after login
    window.location.href = "/admin/articles/dashboard"; // redirect ke dashboard admin
  };
